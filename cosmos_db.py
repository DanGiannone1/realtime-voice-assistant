...
class CosmosDBManager:
    ...
    def _load_env_variables(self, cosmos_host=None, cosmos_database_id=None, cosmos_container_id=None):
        load_dotenv()
        print(f"COSMOS_HOST: {os.environ.get('COSMOS_HOST')}")
        print(f"COSMOS_DATABASE_ID: {os.environ.get('COSMOS_DATABASE_ID')}")
        print(f"COSMOS_CONTAINER_ID: {os.environ.get('COSMOS_CONTAINER_ID')}")
